  ...
  const [textProperties, settextProperties] = useState({
    ...
    <div className="flex flex-col gap-5">
        <div className={"flex w-40 justify-between relative left-3 top-5"}>
            ...
            <button disabled={openModalChangeColor.type === "line"} onClick={()=>openModalChangeColorHandler("base")}
            className={`${openModalChangeColor.type === "base" &&"bg-gray-300"} ${openModalChangeColor.type === "line" && "cursor-not-allowed"} 
            tooltip hover:bg-gray-300  p-1 right-7 top-[-4px] rounded-md `}
            >
            <ColorWheelIcon />
            <span className="tooltiptextup">{openModalChangeColor.state && openModalChangeColor.type === "line" ? "Finalice la accion anterior" : "Cambiar estilo"}</span>
            </button>
        </div>

        <div className={styleDivContainer}>
            <label className="font-medium">Color de Linea:</label>
            <button disabled={openModalChangeColor.type === "base"} onClick={()=>openModalChangeColorHandler("line")}
            className={`${ openModalChangeColor.type === "line" && "bg-gray-300"} ${openModalChangeColor.type === "base" && "cursor-not-allowed"} 
            tooltip hover:bg-gray-300  p-1 right-7 top-[-4px] rounded-md `}
            >
            <ColorWheelIcon />
            <span className="tooltiptextup">{openModalChangeColor.state && openModalChangeColor.type === "base" ? "Finalice la accion anterior": "Cambiar estilo"}</span>
            </button>
        </div>
        ...
        <div className={styleDivContainer}>
            ...
            <input className={styleInput} type="number" min={1} value={layersPropertyStyle.radius}
        ...
        <div className={styleDivContainer}>
            ...
            <input  className={styleInput} type="number" min={0} value={layersPropertyStyle.strokeWidth}
        ...
        <>
            <div className={styleDivContainer}>
                ...
                <select value={layersPropertyStyle.pitchAligment} className={styleInput}
            ...
            <div className={styleDivContainer}>
                ...
                <select  value={layersPropertyStyle.pitchScale} className={styleInput}
        ...
        <div className={styleDivContainer}>
          ...
          <button onClick={() =>settextProperties({ ...textProperties, opentextColor: true }) }
            className={`tooltip hover:bg-gray-300 p-1 right-6 top-[-4px] rounded-md ${textProperties.opentextColor && "bg-gray-300"}`}
          >
            <ColorWheelIcon />
            <span className="tooltiptextup">{textProperties.opentextColor ? "Finalice la acción anterior": "Cambiar estilo"}</span>
          </button>
        </div>

        <div className={styleDivContainer}>
            <label className={styleLabel}>Tamaño</label>
            <input className={styleInput} type="number" value={layersPropertyStyle.textSize} min={12} max={32} step={2}
        ...
        <div className={styleDivContainer}>
          ...
          <select className={styleInput} value={layersPropertyStyle.textAnchor}
        ...
        <div className={styleDivContainer}>
          ...
          <select  className={styleInput} value={layersPropertyStyle.textOverlap}
        ...
        <div className={styleDivContainer}>
          ...
          <select className={styleInput} value={layersPropertyStyle.textField}
